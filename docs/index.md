# JustinePedia
Bienvenu sur JustinePedia :D.

Par Nat.

Ce site est notre WikiPedia!!!! 
## Créer une page!
Alors d'abord tu dois avoir un compte [Github](https://github.com/signup)

Quand tu as un compte va demandée a Nat de te rajouter en collaborateur

Après tu dois aller sur ce lien : https://github.com/natounet21/JustinePedia/new/main/docs/articles
